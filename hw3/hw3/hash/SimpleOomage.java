...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        boolean greenEqual = this.green == other.green;
        boolean redEqual = this.red == other.red;
        boolean blueEqual = this.blue == other.blue;
        return greenEqual && redEqual && blueEqual;
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return 256 * red / 5 + 256 * green / 5 + blue / 5;
        }
    }
